<?php   
session_start();
if (isset($_GET['visit']) && $_GET['visit'] == 'true'){
    $_SESSION['visit'] = true;
}
if ((isset($_GET['action']) && $_GET['action'] == 'logout') || !$_SESSION['visit']){
    $_SESSION = array();
    session_destroy();
...
if ((!isset($_POST['username']) || $_POST['username'] == "") && !isset($_SESSION['username'])){
    ...
    echo '<br><a href="http://web.engr.oregonstate.edu/~armstrla/content2.php">here</a>';
    echo " to visit content 2.";
}   
?>
